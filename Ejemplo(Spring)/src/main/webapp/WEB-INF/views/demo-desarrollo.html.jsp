...
<head lang="en">
    ...
    <script src="https://devpago.culqi.com/culqi.js"></script>
...
<table id="t_autorizacion">
    ...
    <tr>
        <td>Mensaje de respuesta usuario</td>
        <td><p id="mensaje_respuesta_usuario"></p></td>
    </tr>
    <tr>
        <td>Ticket</td>
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if (tipo_respuesta_venta == "venta_exitosa") {
                    ...
                    document.getElementById("id_transaccion").innerHTML = obj["ticket"];
                    ...
                    document.getElementById("numero_tarjeta").innerHTML = obj["numero_tarjeta"];
